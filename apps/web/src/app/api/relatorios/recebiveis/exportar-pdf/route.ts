// GET /api/relatorios/recebiveis/exportar-pdf — exporta o relatório de recebíveis agrupado por
// empresa em .pdf (Módulo de Relatórios). Mesmo padrão de api/extrato/exportar-ofx/route.ts.
import { z } from 'zod';
